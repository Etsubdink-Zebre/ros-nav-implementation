...
class OType(Enum):
    UNKNOWN = 0
    PERSON  = 1   # < 0.5m radius, moving
    CART    = 2   # 0.5-0.9m radius, moving
    STATIC  = 3   # Not moving
...
class ObstacleTracker(Node):
    ...
    def _publish_markers(self):
        ...
        COLOR = {
            OType.PERSON:  (1.0, 0.3, 0.0, 0.7),
            OType.CART:    (0.0, 0.6, 1.0, 0.7),
            OType.STATIC:  (0.5, 0.5, 0.5, 0.4),
            OType.UNKNOWN: (1.0, 1.0, 0.0, 0.6),
        }
